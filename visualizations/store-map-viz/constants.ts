...
export const MARKER_COLOURS = {
    ...
    criticalColourBorder : "#DF2E234D", 
    criticalColourText : "#fff", 
    warningColour: "#FFD23D", // Amber color for warning
    warningColourBorder: "#FFD23D4D",
    warningColourText: "#293238", 
    safeColour : "#05865B", // Green color for safe
    safeColourBorder : "#05865B4D", 
    safeColourText : "#FFF", 
    groupColor: "#757575", //grey for group
    groupBorder: "#7575754d" //border, including transparency
}
